...
DATABASES = {
    "default": {
        ...
        "NAME": "postgres",
        "USER": "postgres.lqhajfybqmrwkozlsffk",
        "PASSWORD": "Avtechnosys123",
        "HOST": "aws-0-ap-south-1.pooler.supabase.com",
        "PORT": "6543",
    },

    # postgresql://postgres.lqhajfybqmrwkozlsffk:[YOUR-PASSWORD]@aws-0-ap-south-1.pooler.supabase.com:6543/postgres
    # "default": {
    #     "ENGINE": "django.db.backends.postgresql",
    #     "NAME": "postgres",
    #     "USER": "postgres",
...
TEMPLATES = [
    {
        "BACKEND": "django.template.backends.django.DjangoTemplates",
        "DIRS": [
            BASE_DIR / "templates",  # Path to the global templates folder
        ],
        "APP_DIRS": True,
        "OPTIONS": {
            "context_processors": [
